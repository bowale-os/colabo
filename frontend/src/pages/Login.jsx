...
export default function Login({ setUser }) {
   ...
   * Connect to your loginUser API and navigate functions
   */
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center cursor-pointer group">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded-sm border-slate-300 text-blue-600 focus:ring-2 focus:ring-blue-500 cursor-pointer"
                  />
